...
}`}),e.jsxs(t,{children:["You can find more information about I18next",e.jsx(h,{to:"https://react.i18next.com/",label:"here",target:"_blank"}),"."]}),e.jsx(a,{children:"GlobalDataLayerLanguageOptions"}),e.jsx(o,{language:"typescript",children:`interface GlobalDataLayerLanguageOptions {
...
}`}),e.jsx(n,{children:"Authentication System"}),e.jsx(t,{children:"The authentication system is separated into two parts: The so called AuthenticationProvider and the AuthenticationView. The AuthenticationProvider is the component which handles authentication (login, logout, ...). The AuthenticationView is the view shown to a user when logging in. Because the authentication provider and the view are separated it's possible to mix authentication providers and views with each other. You are also able to just develop a new authentication provider without developing a new authentication view."}),e.jsx(t,{children:"The framework provides two authentication providers and two authentication views. However, you can implement custom authentication providers (for example for authentication with Microsoft Azure) and own authentication views."}),e.jsx(a,{children:"DummyAuthenticationProvider"}),e.jsxs(t,{children:[e.jsx("em",{children:"DummyAuthenticationProvider"})," is the default authentication provider (which will get used if nothing is specified by you) and allows every combination of email and password. This authentication provider is intended to be used while developing when there is no backend authentication service yet. This enables you to show a realistic workflow to your client. You are able to pass additional values and functions as an object of key-value pairs (for example"," ",e.jsx("code",{children:"{ getUserGroups: () => [] }"}),") to"," ",e.jsx("em",{children:"DummyAuthenticationProvider"})," by using the property"," ",e.jsx("em",{children:"additionalContextValues"}),". These values and functions will be shared using the auth context. To do this you have to include the"," ",e.jsx("em",{children:"DummyAuthenticationProvider"})," above the ",e.jsx("em",{children:"GlobalDataLayer"})," ","on your own (as shown in the beginning of this documentation). The"," ",e.jsx("em",{children:"GlobalDataLayer"})," component detects that the authentication provider has been changed and will skip the default process. The properties of the ",e.jsx("em",{children:"DummyAuthenticationProvider"})," are defined as follows:"]}),e.jsx(o,{title:"PageInterface AWSAuthenticationProvider",language:"typescript",children:`export interface Props {
...
BasicLoginView.contextType = AuthContext;`})]}),U=Object.freeze(Object.defineProperty({__proto__:null,default:j},Symbol.toStringTag,{value:"Module"})),T=()=>e.jsxs(s,{children:[e.jsx(i,{children:"UILayer: Navigation and Content Area Elements"}),e.jsx(n,{children:"Introduction"}),e.jsx(t,{children:"The UILayer provides the UI components and some basic logic for the application. The UILayer has the following properties, some of them are explained later on:"}),e.jsx(o,{title:"PageInterface PageUiLayer",language:"typescript",children:`export interface Props {
...
</svg>`}),e.jsx(n,{children:"Interfaces"}),e.jsx(a,{children:"SettingsMenuOptions: How to configure the settings menu?"}),e.jsx(t,{children:"These options (property of the UILayer component) allow you to configure the settings menu."}),e.jsx(o,{title:"SettingsMenuOptions",language:"typescript",children:`interface SettingsMenuOptions {
...
}`}),e.jsx(a,{children:"UserMenuOptions: How to configure the user menu?"}),e.jsx(o,{language:"typescript",children:`export interface UserMenuOptions {
...
}`}),e.jsx(a,{children:"HeaderOptions: How to configure the header?"}),e.jsx(t,{children:"These options (property of the UILayer component) allow you to configure the header of the main view. Note, that since Version 12.0.2 there is no default IAV-Company-Logo set, due to legal requirements, as the IAV Frontend Framework will be Open Source."}),e.jsx(o,{title:"PageInterface HeaderOptions",language:"typescript",children:`interface HeaderOptions {
...
}`}),e.jsxs(t,{children:["If the user wants to add their own elements in the header, they can either use their own React elements or fall back on the",e.jsx("strong",{children:"HeaderMenuElement"})," for a menu or",e.jsx("strong",{children:"HeaderPanelElement"})," for an overlay panel provided by the IAV Frontend Framework."]}),e.jsx(a,{children:"AuthOptions: How to configure the authentication view?"}),e.jsx(t,{children:"These options (property of the UILayer component) allow you to configure the authentication view."}),e.jsx(o,{title:"PageInterface AuthOptions",language:"typescript",children:`interface AuthOptions {
...
}`}),e.jsx(a,{children:"NavbarOptions: How to configure the navigation bar?"}),e.jsx(o,{language:"typescript",children:`export interface NavbarOptions {
...
};`}),e.jsx(t,{children:"The framework also exports templates. These are just predefined arrays of styles. These are the following:"}),e.jsx(p,{bulletType:"bullet",items:["DEFAULT: This template should be used for simple content areas (for example it sets a colored gap).","CONTENT_CELLS: This template should be used if you want to use the ContentCell component."]}),e.jsx(o,{title:"First Example",language:"typescript",children:`<ContentStyle
...
};`}),e.jsx(t,{children:"The resulting content area looks like this:"}),e.jsx(l,{src:"assets/content-area/content-area.png",fromGhPages:!0})]}),V=Object.freeze(Object.defineProperty({__proto__:null,default:k},Symbol.toStringTag,{value:"Module"})),I=()=>e.jsxs(s,{children:[e.jsx(i,{children:"Color Settings and Dark Mode"}),e.jsx(n,{children:"Introduction"}),e.jsxs(t,{children:["Color and theme (dark / light mode) information is stored and provided by the React context called ",e.jsx("strong",{children:"ColorSettings"}),"context. The ColorSettings context`s provider component is embedded inside the ColorProvider component. The ColorProvider itself is contained in GlobalDataLayer. Your interface to the ColorProvider component is the colorSettings property of the GlobalDataLayer component. This property will be explained later on."]}),e.jsx(t,{children:"Using these options you are able to set custom colors (especially for framework components). Furthermore, the ColorSettings context provides you the information whether the dark mode is activated. This allows you to implement a dark mode four your components."}),e.jsx(t,{children:"All colors are exported by the framework's constants file. The following code snippet shows you how to import these colors:"}),e.jsx(o,{title:"Example exported color",language:"typescript",children:'import {BLUE0} from "@iavofficial/frontend-framework/constants";'}),e.jsx(i,{children:"Overwrite default colors"}),e.jsx(n,{children:"CSS"}),e.jsx(t,{children:"Besides providing the colors as JS constants, all colors are defined as CSS constants within the root and can be used within the css files of the project. The following code snippet shows you how to use these colors inside css files:"}),e.jsx(o,{title:"Example exported css constants and variables definition",language:"typescript",children:`// Example for exported color by the framework:
:root {
   --blue-0: #001a54;
}
...
}`}),e.jsx(t,{children:"The following interfaces show that most settings are divided by the state of the corresponding element: default, hovering and active."}),e.jsx(a,{children:"Color options of the header"}),e.jsx(t,{children:"Using these options you can define the colors of the main view's header."}),e.jsx(o,{title:"PageInterface HeaderColorType",language:"typescript",children:`export interface HeaderColorOptions {
    backgroundColor?: string;
    settingsIconColor?: string;
    userIconColor?: string;
}`}),e.jsx(a,{children:"Color options of the navigation bar (including the navigation tabs)"}),e.jsx(t,{children:"Using these options you can define the colors of the main view's navigation bar."}),e.jsx(o,{title:"PageInterface NavbarColorType",language:"typescript",children:`export interface NavbarColorOptions {
    backgroundColor?: string;
...
}`}),e.jsx(a,{children:"Color options of the content area"}),e.jsx(t,{children:"Using these options you can set the colors of the content area:"}),e.jsx(o,{title:"ContentColorType",language:"typescript",children:`export interface ContentAreaColorOptions {
    backgroundColor?: string;
}`}),e.jsx(a,{children:"Color options of the content bar (including tabs)"}),e.jsx(t,{children:"Using these options you can set the colors of the tabs of the content bar:"}),e.jsx(o,{title:"ContentbarTabColorOptions",language:"typescript",children:`export interface ContentbarColorOptions {
    backgroundColor?: string;
...
}`}),e.jsx(a,{children:"Color options for content cells"}),e.jsx(t,{children:"Using these options you can set the colors of content cells:"}),e.jsx(o,{language:"typescript",children:`export interface ContentCellColorOptions {
    backgroundColor?: string;
}`}),e.jsx(a,{children:"Color options for the authentication view"}),e.jsx(t,{children:"Using these options you can set the colors of the authentication view:"}),e.jsx(o,{title:"Interfaces ContentElements",language:"typescript",children:`export interface AuthenticationViewColorOptions {
...
export interface AuthenticationColorType {
    ...
    inputFieldTextColor?: string;
    passwortRequirementsTextColor?: string; // Defines the color of the text for the requirements to set a new password of the AWS authentication view.
}`}),e.jsx(i,{children:"Other color options"}),e.jsx(t,{children:"To change the color of the PrimeReact components DropDown and ContextMenu you have to overwrite the following css variables:"}),e.jsx(o,{title:"CSS Properties",language:"css",children:`:root {
...
};`}),e.jsx(t,{children:"However, deciding which colors should be used regarding the theme inside your components is a bad practice. Instead you should maintain the currently used colors in a central place like the framework does. Consult the framework implementation (especially the ColorProvider component) for further details."}),e.jsx(a,{children:"Implement dark mode using the color-theme html attribute"}),e.jsx(t,{children:'If the user activates the dark mode the "color-theme" html attribute will be set (at html body). This enables you to style your components for the light and dark mode using CSS attribute selectors like so:'}),e.jsx(o,{language:"typescript",children:`.example {
    background-color: white;
}

[color-theme="dark"] .example {
    background-color: black;
}`}),e.jsx(t,{children:'This CSS will set a white background for the class "example" if the color-theme is not "dark" (light mode is activated). If the color-theme is set to "dark" (dark mode is activated) it will set the background to black.'}),e.jsx(i,{children:"How to disable the dark mode"}),e.jsxs(t,{children:["To disable the dark mode use the ",e.jsx("em",{children:"hideColorThemeToggler"})," option inside ",e.jsx("em",{children:"settingsMenuOptions"}),"of the UILayer component. This will prevent the user from changing the theme."]})]}),M=Object.freeze(Object.defineProperty({__proto__:null,default:I},Symbol.toStringTag,{value:"Module"})),P=()=>e.jsxs(s,{children:[e.jsx(i,{children:"Starting the Example Project"}),e.jsx(t,{children:"The framework's repository contains an example project which is used for development purposes and to present a basic example for framework usage. If you want to start the example project, first you have to clone the framework's repository."}),e.jsx(t,{children:"You can start the example project by executing the command inside the repository's root folder."}),e.jsx(o,{language:"bash",children:"npm run run-example"}),e.jsx(t,{children:"The example project does not use a pulled version of the framework. Instead it uses a locally build version of the framework. The mentioned command triggers a new build of the framework and starts the example project using this build. However, changes you make to the framework itself won't have any effect since the build is just executed once. If you want to play with the framework and see the consequences of your changes in the example project this page is of interest for you."})]}),z=Object.freeze(Object.defineProperty({__proto__:null,default:P},Symbol.toStringTag,{value:"Module"})),A=()=>e.jsxs(s,{children:[e.jsx(n,{children:"Cloning the Repository"}),e.jsx(t,{children:"If you want to play with the framework and the contained example project, you have to clone the framework's Git repository first."}),e.jsx(n,{children:"The Example Project"}),e.jsx(t,{children:"As mentioned, the repository contains the framework and an example project. As the framework isn't a UI by itself, you cannot see the consequences of framework changes without a project using the framework. This is where the example project comes into use. The example project uses the locally built framework as a file dependency in order to visualize the consequences of framework changes."}),e.jsx(a,{children:"Setting Up and Running the Example Project"}),e.jsxs(t,{children:["To start the example project you have to execute npm run setup_and_build inside the root folder of the ",e.jsx("strong",{children:"repository"}),". This will setup the environment and start the development server at port 3000."]}),e.jsx(a,{children:"Making Real-Time Changes to the Framework"}),e.jsx(t,{children:"If you want to make changes to the framework and see the consequences of these changes in real time you have to execute the following steps by yourself"}),e.jsx(o,{language:"bash",children:"npm run dev"})]}),q=Object.freeze(Object.defineProperty({__proto__:null,default:A},Symbol.toStringTag,{value:"Module"})),S=()=>e.jsxs(s,{children:[e.jsx(i,{children:"FAQ"}),e.jsx(t,{children:"This page lists common questions and problems and links corresponding issues."}),e.jsx(n,{children:"Problems using the SVG format as React Component with Vite"}),e.jsx(t,{children:"In a few scenarios, the framework requires the use of SVG Files (e.g., Icons). To be able to set the color of the SVG inside the Framework, the Icons must be imported as React Components."}),e.jsx(t,{children:"Use the following steps to solve issues regarding the SVG import as React Components:"}),e.jsxs(t,{children:['Install the vite-plugin-svgr with the command "npm i vite-plugin-svgr" and configure it as shown'," ",e.jsx(h,{label:"here",to:"https://www.npmjs.com/package/vite-plugin-svgr"}),". If this doesn’t help, further possible solutions can be found"," ",e.jsx(h,{to:"https://stackoverflow.com/questions/74720726/type-definition-for-vite-plugin-svgr",label:"here"}),"."]}),e.jsx(n,{children:"Can the IAV Frontend Framework be used with Angular?"}),e.jsx(t,{children:"No, the IAV Frontend Framework only supports React Components and is therefore only suitable for React-based projects."})]}),Y=Object.freeze(Object.defineProperty({__proto__:null,default:S},Symbol.toStringTag,{value:"Module"})),f=Object.assign({"./pages/pageColorSettings.tsx":()=>r(()=>Promise.resolve().then(()=>M),void 0),"./pages/pageContentArea.tsx":()=>r(()=>Promise.resolve().then(()=>V),void 0),"./pages/pageExampleProject.tsx":()=>r(()=>Promise.resolve().then(()=>z),void 0),"./pages/pageFaq.tsx":()=>r(()=>Promise.resolve().then(()=>Y),void 0),"./pages/pageGlobalDataLayer.tsx":()=>r(()=>Promise.resolve().then(()=>U),void 0),"./pages/pageInformation.tsx":()=>r(()=>Promise.resolve().then(()=>F),void 0),"./pages/pageInstallationGuide.tsx":()=>r(()=>Promise.resolve().then(()=>N),void 0),"./pages/pageInterface.tsx":()=>r(()=>Promise.resolve().then(()=>W),void 0),"./pages/pageOverview.tsx":()=>r(()=>Promise.resolve().then(()=>D),void 0),"./pages/pagePlayground.tsx":()=>r(()=>Promise.resolve().then(()=>q),void 0),"./pages/pageUiLayer.tsx":()=>r(()=>Promise.resolve().then(()=>H),void 0)}),K=async c=>{var u;const d=[];for(const L in f){const m=await f[L](),O=(u=c.find(_=>m.default.name===_.element.name))==null?void 0:u.path;d.push({module:m.default,route:O})}return d},y=[{path:"overview",label:"Quick Overview",element:x},{path:"information",label:"01 - Important Information",element:w},{path:"installation-guide",label:"02 - Installation",element:v},{path:"interface",label:"03 - Interface",element:C},{path:"globaldatalayer",label:"04 - GlobalDataLayer",element:j},{path:"uilayer",label:"05 - UiLayer",element:T},{path:"content-area",label:"06 - Content Area",element:k},{path:"color-settings-and-dark-mode",label:"07 - Color Settings and Dark Mode",element:I},{path:"example-project",label:"08 - Example Project",element:P},{path:"playground",label:"09 - Playground",element:A}],b=[{path:"faq",label:"FAQ",element:S}],Z=()=>{const c=R(y,b);return e.jsxs(e.Fragment,{children:[e.jsxs(B,{children:[e.jsx(g,{routes:y}),e.jsx("h3",{children:"Need help?"}),e.jsx(g,{routes:b})]}),e.jsx(G,{routes:c,getPages:K})]})};export{Z as default,K as getPages};
